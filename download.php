...
$dropboxFilePath = '/ct_iceage_sid_21464_10f2d363_edac618f.jpg';

$localFilePath = 'C:\Users\noufa\Downloads\downloaded_sample.jpg';

function downloadFileFromDropbox($accessToken, $dropboxFilePath, $localFilePath)
{
    ...
    if ($httpCode === 200) {
        ...
        echo "Failed to download file. Error: " . ($errorResponse['error_summary'] ?? 'Unknown error') . "\n";
    }

    curl_close($ch);
}

downloadFileFromDropbox($accessToken, $dropboxFilePath, $localFilePath);
